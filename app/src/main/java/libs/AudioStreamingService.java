    ...
    private void createNotification(MediaMetaData mSongDetail) {
        try {
            ...
            if (pendingIntent != null) {
                notification = new NotificationCompat.Builder(getApplicationContext()).setSmallIcon(R.mipmap.ic_launcher)
            ...
            if (albumArt != null) {
                ...
                notification.contentView.setImageViewResource(R.id.player_album_art, R.mipmap.ic_launcher);
                if (supportBigNotifications) {
                    notification.bigContentView.setImageViewResource(R.id.player_album_art, R.mipmap.ic_launcher);
                }
            }
