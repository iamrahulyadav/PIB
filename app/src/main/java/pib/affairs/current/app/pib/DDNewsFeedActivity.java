        ...
        if (nativeAd == null) {
            ...
            nativeAd.setAdListener(new AdListener() {
                ...
                public void onAdLoaded(Ad ad) {
                    View adView = NativeAdView.render(DDNewsFeedActivity.this, nativeAd, NativeAdView.Type.HEIGHT_400);
                    LinearLayout nativeAdContainer = (LinearLayout) findViewById(R.id.ddnews_adContainer_LinearLayout);
